...
public class RadlyGoogleAuth: CAPPlugin {
    ...
    public override func load() {
        print("🔵 RadlyGoogleAuth plugin loaded!")
    }
    ...
    private func performSignIn(_ call: CAPPluginCall) {
        ...
        let configuration = GIDConfiguration(
            ...
            serverClientID: "590422684479-qjrih3fq3086q1gh6o3qj0maj0lnf9m0.apps.googleusercontent.com"
        )
