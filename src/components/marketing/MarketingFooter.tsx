...
export function MarketingFooter() {
  ...
  return (
    <footer className="border-t border-[rgba(255,255,255,0.08)] bg-[rgba(26,21,16,0.85)] px-6 py-12 text-sm text-[rgba(232,220,200,0.7)] backdrop-blur">
      <div className="mx-auto flex w-full max-w-6xl flex-col items-center gap-6 text-center sm:flex-row sm:items-start sm:justify-between sm:text-left">
        <div className="flex flex-col items-center gap-4 sm:items-start">
          ...
          <p className="max-w-sm text-xs uppercase tracking-[0.28em] text-[rgba(168,159,145,0.6)]">
            {siteConfig.shortName} assists radiologists. Clinicians review and finalize every report.
          </p>
        </div>

        <div className="flex flex-wrap items-center justify-center gap-4 text-xs uppercase tracking-[0.28em] text-[rgba(168,159,145,0.6)] sm:justify-end">
      ...
      <div className="mx-auto mt-6 w-full max-w-6xl text-center text-xs uppercase tracking-[0.24em] text-[rgba(168,159,145,0.4)]">
