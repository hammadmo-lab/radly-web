...
export function MobileHomePage() {
  const features = [
    { icon: Zap, title: 'Fast drafting', description: 'Get structured reports in under 2 minutes' },
    { icon: Brain, title: 'Clinical nuance', description: 'Built for radiology terminology' },
    { icon: Layers, title: 'Structured output', description: 'Ready for PACS and templates' },
  ]
    ...
    <div className="bg-[var(--ds-bg-gradient)] text-white min-h-screen">
      ...
      >
        <motion.div
          ...
          className="mb-8"
        >
          <Image src="/brand/Radly.png" alt="Radly" width={280} height={93} priority className="h-auto w-auto max-w-[280px]" />
        </motion.div>
        ...
        >
          ...
          <p className="text-sm text-white/60 text-center">5 free reports • No credit card needed</p>
        </motion.div>
      </motion.div>
      ...
      >
        ...
        <div className="space-y-3">
          <Link href="/app/generate" className="block w-full px-6 py-4 bg-[rgba(255,255,255,0.06)] hover:bg-[rgba(255,255,255,0.1)] active:bg-[rgba(255,255,255,0.08)] text-white font-semibold rounded-2xl transition-all duration-200 text-center touch-manipulation min-h-[52px] flex items-center justify-center border border-[rgba(255,255,255,0.12)] hover:border-[rgba(75,142,255,0.4)] hover:shadow-[0_4px_16px_rgba(75,142,255,0.2)]">Create New Report</Link>
          <Link href="/app/reports" className="block w-full px-6 py-4 bg-[rgba(255,255,255,0.06)] hover:bg-[rgba(255,255,255,0.1)] active:bg-[rgba(255,255,255,0.08)] text-white font-semibold rounded-2xl transition-all duration-200 text-center touch-manipulation min-h-[52px] flex items-center justify-center border border-[rgba(255,255,255,0.12)] hover:border-[rgba(75,142,255,0.4)] hover:shadow-[0_4px_16px_rgba(75,142,255,0.2)]">View My Reports</Link>
          <Link href="/app/settings" className="block w-full px-6 py-4 bg-[rgba(255,255,255,0.06)] hover:bg-[rgba(255,255,255,0.1)] active:bg-[rgba(255,255,255,0.08)] text-white font-semibold rounded-2xl transition-all duration-200 text-center touch-manipulation min-h-[52px] flex items-center justify-center border border-[rgba(255,255,255,0.12)] hover:border-[rgba(75,142,255,0.4)] hover:shadow-[0_4px_16px_rgba(75,142,255,0.2)]">Settings</Link>
        </div>
      </motion.div>
    </div>
  )
