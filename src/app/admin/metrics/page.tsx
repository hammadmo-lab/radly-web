...
// Dynamically import SummaryDashboard to reduce initial bundle size
// Chart.js and related dependencies are only loaded when admin accesses metrics page
const SummaryDashboard = dynamic(
  () => import('@/components/admin/metrics-v2/SummaryDashboard').then(mod => ({ default: mod.SummaryDashboard })),
  {
    ssr: false,
    loading: () => (
