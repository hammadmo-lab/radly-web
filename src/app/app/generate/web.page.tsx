            ...
            <CardContent className="p-4 sm:p-6">
              <div className="flex sm:hidden justify-center gap-2 mb-4">
                {steps.map((step) => (
                  <motion.div
                    key={step.id}
                    className={`h-2 rounded-full transition-all ${currentStep >= step.id
                      ? 'bg-[linear-gradient(90deg,#D4B483_0%,#C2A478_50%,#A89F91_100%)] w-8'
              ...
              <div className="hidden sm:flex items-center justify-between relative">
                <div className="absolute top-6 left-0 right-0 h-0.5 bg-[rgba(207,207,207,0.18)]">
                  <motion.div
                    className="h-full bg-[linear-gradient(90deg,#D4B483_0%,#C2A478_60%,#A89F91_100%)]"
                        ...
                        <div
                          className={cn(
                            ...
                            isActive || isCompleted
                              ? "border-[rgba(212,180,131,0.45)] bg-[linear-gradient(135deg,#D4B483,#C2A478)] text-[#1A1510] shadow-[0_18px_42px_rgba(212,180,131,0.4)]"
                              : "border-[rgba(255,255,255,0.12)] bg-[rgba(12,16,28,0.85)] text-[rgba(207,207,207,0.5)]"
                          )}
                        >
                          <step.icon className="h-6 w-6" />
                        </div>
                        <span className={cn("text-xs uppercase tracking-[0.18em] text-[rgba(207,207,207,0.5)]", isActive && "text-[#D4B483]")}>
                          {step.name}
                        </span>
                      </div>
                    )
            ...
            <div className="flex flex-col sm:flex-row sm:items-center gap-4">
              ...
              <div className="flex gap-2 sm:gap-3 sm:flex-shrink-0">
                ...
                <Button
                  ...
                  className="flex-1 sm:flex-none min-h-[44px] rounded-lg bg-[linear-gradient(90deg,#D4B483_0%,#C2A478_100%)] text-[#1A1510] shadow-[0_12px_28px_rgba(212,180,131,0.32)]"
                >
                  Restore
                </Button>
              </div>
                ...
                <div className="aurora-card border border-[rgba(255,255,255,0.08)] overflow-hidden">
                  <div className="border-b border-[rgba(255,255,255,0.08)] bg-[rgba(12,16,28,0.78)] px-4 sm:px-6 py-4">
                    <div className="flex items-center gap-3">
                      <div className="flex h-10 w-10 items-center justify-center rounded-lg bg-[linear-gradient(135deg,#D4B483,#C2A478)] shadow-[0_14px_32px_rgba(212,180,131,0.35)] flex-shrink-0">
                        <FileText className="h-5 w-5 text-[#1A1510]" />
                      </div>
                  ...
                  <div className="p-4 sm:p-6 md:p-8">
                    <div className="max-w-2xl mx-auto">
                      <div className="rounded-2xl border border-[rgba(212,180,131,0.3)] bg-[rgba(12,16,28,0.65)] p-5 sm:p-6 text-center">
                        <h3 className="text-xl sm:text-2xl font-semibold text-white mb-4">
                          {templateInfo.templateTitle || "(Untitled Template)"}
                        </h3>
                        <div className="flex flex-wrap items-center justify-center gap-2 text-xs sm:text-sm text-[#E8DCC8] mb-6">
                          {templateInfo.modality && (
                            <span className="rounded-full bg-[rgba(212,180,131,0.18)] text-[#D4B483] px-3 py-1.5 font-semibold">
                              {templateInfo.modality}
                            </span>
                          )}
                        ...
                        <Button
                          variant="ghost"
                          size="sm"
                          className="rounded-lg border border-[rgba(255,255,255,0.12)] bg-[rgba(18,22,36,0.72)] px-5 py-2 text-[rgba(207,207,207,0.8)] hover:border-[rgba(212,180,131,0.45)] hover:bg-[rgba(212,180,131,0.18)] hover:text-white min-h-[44px]"
                          onClick={() => router.push('/app/templates')}
                        >
                          Change template
                        </Button>
