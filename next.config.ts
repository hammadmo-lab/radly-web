...
const orchestratorBase = (process.env.NEXT_PUBLIC_ORCHESTRATOR_URL || process.env.VITE_ORCHESTRATOR_URL || 'https://bot.radly.app').replace(/\/+$/, '');
...
const securityHeaders = [
  ...
  },
  {
    ...
    value: [
      ...
      `connect-src 'self' ${apiBase} ${orchestratorBase} https://api.radly.app wss://${new URL(apiBase).hostname} ${apiBase} https://*.supabase.co https://cloudflareinsights.com https://www.google-analytics.com https://analytics.google.com https://www.googletagmanager.com wss:`,
